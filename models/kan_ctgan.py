...
from torch.nn import BatchNorm1d, Dropout, LeakyReLU, Linear, Module, ReLU, Sequential, functional, SiLU
...
class Discriminator_KAN(Module):
    def __init__(self, input_dim, discriminator_dim, pac=10):
        ...
        for item in list(discriminator_dim):
            seq += [KANLinear(dim, item), SiLU(0.2), Dropout(0.5)]
            dim = item
...
class KANCTGAN(BaseSynthesizer):
